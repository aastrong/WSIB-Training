    ...
    console.warn('unable to connect to top frame for connecting dev tools');
      ...
      #storybook-docs[hidden] {
        display: none !important;
            ...
            window['STORIES'] = [{"titlePrefix":"","directory":"./components","files":"**/*/card.stories.json","importPathMatcher":"^\\.[\\\\/](?:components(?:\\/(?!\\.)(?:(?:(?!(?:^|\\/)\\.).)*?)\\/|\\/|$)(?!\\.)(?=.)[^/]*?\\/card\\.stories\\.json)$"}];
      ...
      import './vendors-node_modules_storybook_addon-a11y_dist_preview_mjs-node_modules_storybook_react_dist_-548f1c.iframe.bundle.js';
