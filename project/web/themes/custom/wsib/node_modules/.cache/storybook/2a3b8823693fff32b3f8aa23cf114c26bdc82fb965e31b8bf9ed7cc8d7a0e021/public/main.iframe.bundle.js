...
/***/ "./components lazy recursive ^\\.\\/.*$ include: (?%21.*node_modules)(?:\\/components(?:\\/(?%21\\.)(?:(?:(?%21(?:^%7C\\/)\\.).)*?)\\/%7C\\/%7C$)(?%21\\.)(?=.)[^/]*?\\/card\\.stories\\.json)$":
/*!**********************************************************************************************************************************************************************************************************************!*\
  !*** ./components/ lazy ^\.\/.*$ include: (?%21.*node_modules)(?:\/components(?:\/(?%21\.)(?:(?:(?%21(?:^%7C\/)\.).)*?)\/%7C\/%7C$)(?%21\.)(?=.)[^/]*?\/card\.stories\.json)$ chunkName: [request] namespace object ***!
  \**********************************************************************************************************************************************************************************************************************/
...
webpackAsyncContext.id = "./components lazy recursive ^\\.\\/.*$ include: (?%21.*node_modules)(?:\\/components(?:\\/(?%21\\.)(?:(?:(?%21(?:^%7C\\/)\\.).)*?)\\/%7C\\/%7C$)(?%21\\.)(?=.)[^/]*?\\/card\\.stories\\.json)$";
...
if (true) {
 ...
 return (() => {
  ...
  module.hot.accept([/*! ./node_modules/@storybook/react/dist/entry-preview.mjs */ "./node_modules/@storybook/react/dist/entry-preview.mjs",/*! ./node_modules/@storybook/react/dist/entry-preview-argtypes.mjs */ "./node_modules/@storybook/react/dist/entry-preview-argtypes.mjs",/*! ./node_modules/@storybook/addon-a11y/dist/preview.mjs */ "./node_modules/@storybook/addon-a11y/dist/preview.mjs",/*! ./.storybook/preview.js */ "./.storybook/preview.js"], __WEBPACK_OUTDATED_DEPENDENCIES__ => {  return (() => {
...
const importers = [
  async (path) => {
    if (!/^\.[\\/](?:components(?:\/(?!\.)(?:(?:(?!(?:^|\/)\.).)*?)\/|\/|$)(?!\.)(?=.)[^/]*?\/card\.stories\.json)$/.exec(path)) {
      return;
    }
  
    const pathRemainder = path.substring(13);
    return __webpack_require__("./components lazy recursive ^\\.\\/.*$ include: (?%21.*node_modules)(?:\\/components(?:\\/(?%21\\.)(?:(?:(?%21(?:^%7C\\/)\\.).)*?)\\/%7C\\/%7C$)(?%21\\.)(?=.)[^/]*?\\/card\\.stories\\.json)$")("./" + pathRemainder);
  }
