...
class __TwigTemplate_a7dfba2bc9e5e5a4bde6d9406206955e extends Template
{
...
($context["alignment"] ?? null)];
    ...
    ";
                ...
                foreach ($context['_seq'] as $context["_key"] => $context["item"]) {
                    ...
                    yield "      ";
                    // line 25
                    $context["classes"] = ["nav-item", (((($tmp = CoreExtension::getAttribute($this->env, $this->source,                     // line 27
$context["item"], "is_expanded", [], "any", false, false, true, 27)) && $tmp instanceof Markup ? (string) $tmp : $tmp)) ? ("menu-item--expanded") : ("")), (((($tmp = CoreExtension::getAttribute($this->env, $this->source,                     // line 28
$context["item"], "is_collapsed", [], "any", false, false, true, 28)) && $tmp instanceof Markup ? (string) $tmp : $tmp)) ? ("menu-item--collapsed") : ("")), (((($tmp = CoreExtension::getAttribute($this->env, $this->source,                     // line 29
$context["item"], "in_active_trail", [], "any", false, false, true, 29)) && $tmp instanceof Markup ? (string) $tmp : $tmp)) ? ("active") : (""))];
                    // line 32
                    yield "      <li";
        ...
        ";
                    // line 34
                    $context["link_classes"] = ["nav-link", (((($tmp = CoreExtension::getAttribute($this->env, $this->source,                     // line 36
$context["item"], "in_active_trail", [], "any", false, false, true, 36)) && $tmp instanceof Markup ? (string) $tmp : $tmp)) ? ("active") : ("")), (((($tmp = CoreExtension::getAttribute($this->env, $this->source, CoreExtension::getAttribute($this->env, $this->source, CoreExtension::getAttribute($this->env, $this->source,                     // line 37
$context["item"], "url", [], "any", false, false, true, 37), "getOption", ["attributes"], "method", false, false, true, 37), "class", [], "any", false, false, true, 37)) && $tmp instanceof Markup ? (string) $tmp : $tmp)) ? (Twig\Extension\CoreExtension::join(CoreExtension::getAttribute($this->env, $this->source, CoreExtension::getAttribute($this->env, $this->source, CoreExtension::getAttribute($this->env, $this->source, $context["item"], "url", [], "any", false, false, true, 37), "getOption", ["attributes"], "method", false, false, true, 37), "class", [], "any", false, false, true, 37), " ")) : ("")), ("nav-link-" . \Drupal\Component\Utility\Html::getClass(CoreExtension::getAttribute($this->env, $this->source, CoreExtension::getAttribute($this->env, $this->source,                     // line 38
